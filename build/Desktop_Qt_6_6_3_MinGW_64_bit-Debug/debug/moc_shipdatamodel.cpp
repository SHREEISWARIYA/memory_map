...
Q_CONSTINIT static const qt_meta_stringdata_CLASSShipDataModelENDCLASS_t qt_meta_stringdata_CLASSShipDataModelENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 15),  // "shipDataChanged"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 16),  // "isLoadingChanged"
        QT_MOC_LITERAL(48, 13),  // "fetchShipData"
        QT_MOC_LITERAL(62, 8),  // "shipData"
        QT_MOC_LITERAL(71, 9)   // "isLoading"
    },
    "ShipDataModel",
    "shipDataChanged",
    "",
...
void ShipDataModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->shipDataChanged(); break;
        case 1: _t->isLoadingChanged(); break;
        case 2: _t->fetchShipData(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ShipDataModel::shipDataChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->getShipData(); break;
...
// SIGNAL 0
void ShipDataModel::shipDataChanged()
{
